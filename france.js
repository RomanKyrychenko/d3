var keyArray = ["varA","varB","varC","varD","varE"];
    ...
    queue() //use queue.js to parallelize asynchronous data loading for cpu efficiency
        .defer(d3.csv, "https://raw.githubusercontent.com/uwcart/cartographic-perspectives/master/interactive-multivariate-choropleth-map-d3/data/unitsData.csv") //load attributes data from csv
        .defer(d3.json, "https://raw.githubusercontent.com/uwcart/cartographic-perspectives/master/interactive-multivariate-choropleth-map-d3/data/EuropeCountries.topojson") //load geometry from countries topojson
        .defer(d3.json, "https://raw.githubusercontent.com/uwcart/cartographic-perspectives/master/interactive-multivariate-choropleth-map-d3/data/FranceRegions.topojson") //load geometry from regions topojson
        .await(callback);
